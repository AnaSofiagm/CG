...
void renderText(const std::string& text) {
	...
	/* Projecção ortogonal para que as coordenadas de desenho 
	coincidam com o tamanho da janela em pixeis*/
...
// Draw SnowMen
	...
	glMaterialfv(GL_FRONT,GL_AMBIENT_AND_DIFFUSE, white);
	const std::string& text = "Nothing picked";
	renderText(text);
