...
void prepareCilinder(float height, float radius, int sides) {
	//2 buffers : vertex coordinates and normals
	float *v;
	float *n;
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(float) * normal * 3, n, GL_STATIC_DRAW);
    free(n);
	free(v);
...
void renderScene(void) {
	...
	// se quiser mudar a cor basta aqui onde tem white meter red ou dark
